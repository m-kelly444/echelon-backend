...
def rate_limit(calls_per_second=1):
    ...
    last_call_time = [0.0]  # Use a list for nonlocal access
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            # If we've made a call too recently, sleep
...
def make_api_request(url, method='get', **kwargs):
    """Make API requests with retry logic and better error handling"""
    try:
        if method.lower() == 'get':
        ...
        if e.response.status_code == 429:
            ...
            # Client errors should be logged but may not be retried
...
# =========================================
# Error handling for Flask/API responses
# =========================================
def handle_api_error(func):
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            # Can customize status code based on error type
            status_code = 500
            ...
            # In Flask, return a tuple of (response, status_code)
